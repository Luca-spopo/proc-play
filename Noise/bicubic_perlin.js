...
This uses curvy noise to get curvy edges
`
...
var rani = function(x)
{
	...
	function bicubic_interpolate(x, y, pins)
	{
...
function makePerlin(DENSITY_X, DENSITY_Y, AMPLITUDE, EASING)
{
	...
	function ret(x, y)
	{
		...
		return AMPLITUDE*bicubic_interpolate(x-i, y-j, xxx)
	}
	return ret;
...
for (var i=0; i<RESOLUTION; i++)
	for(var j=0; j<RESOLUTION; j++)
	{
		...
		grid[i][j] = contextualize(buffer, i, j)(si, sj)
	}
